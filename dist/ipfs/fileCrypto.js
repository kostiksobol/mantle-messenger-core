import { arrayBufferToBase64, base64ToArrayBuffer, randomBytes, } from "../crypto/encoding";
...
async function importFileAesKey(chatKeyBase64) {
...
export async function encryptFileBlob(chatKeyBase64, file) {
...
export async function decryptFileBlob(chatKeyBase64, encryptedBlob, ivBase64, mime = "application/octet-stream") {
    const key = await importFileAesKey(chatKeyBase64);
    ...
    }, key, await encryptedBlob.arrayBuffer());
